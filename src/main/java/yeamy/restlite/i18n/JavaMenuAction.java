...
public class JavaMenuAction extends AbstractMenuAction {
    ...
    public static void createJava(Object req, Project project) throws Exception {
    ...
    public static void createJava(Object req, VirtualFile pkg, String pkgName) throws Exception {
...
//        VirtualFile pkg = getPackage(req, src, conf.getPackage());
    ...
    private static void createJavaFile(Object req, VirtualFile pkg, AbstractFile<?> f) throws LangException {
